 ...
 */
final class Version20211222140313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id VARCHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, amount INT NOT NULL, type VARCHAR(255) NOT NULL, transaction_date DATE NOT NULL, PRIMARY KEY(id))');
