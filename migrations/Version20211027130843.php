 ...
 */
final class Version20211027130843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, name VARCHAR(50) NOT NULL, amount INT NOT NULL, transaction_date DATE NOT NULL, type VARCHAR(20) NOT NULL, PRIMARY KEY(id))');
